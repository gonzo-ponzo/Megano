...
class Shop(Model):
    ...
    image = models.ImageField(blank=True, upload_to="shop_logo/%Y/%m/%d", verbose_name=_("логотип"))
    user = models.ForeignKey(User, on_delete=models.PROTECT, verbose_name=_("владелец"))
...
class ShopImage(Timestampable):
    ...
    image = models.ImageField(blank=False, upload_to="shop_photo/%Y/%m/%d", verbose_name=_("фото"))
