...
class Shop(Model):
    ...
    email = models.CharField(max_length=100, validators=[validate_email], verbose_name=_("email"))
    ...
    user = models.OneToOneField(User, blank=True, null=True, on_delete=models.PROTECT, verbose_name=_("пользователь"))
